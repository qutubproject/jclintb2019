// Settings
  ...
  // Only the two settings below should need to be edited by the user.

  // 1. Repository root. Start Stata in the repository root, or edit this line.

  global dir "."

  // 2. Location of the data files (not distributed in this repository; see the
  //    Data Access section of README.md). Place the granted files here.
